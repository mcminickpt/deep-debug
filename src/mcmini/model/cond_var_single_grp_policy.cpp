...
void ConditionVariableSingleGroupPolicy::receive_broadcast_message() {
...
void ConditionVariableSingleGroupPolicy::wake_thread(runner_id_t tid) {
...
bool ConditionVariableSingleGroupPolicy::has_waiters() const {
